...
$DB_user = 'tymlexvp_cutevpn';
$DB_pass = 'Regina143$';
$DB_name = 'tymlexvp_cutevpn';
...
$data = '';
$premium = "duration > 0 AND frozen = 0 AND is_active='1'";
$vip = "frozen = 0 AND vip_duration > 0 AND is_active='1'";
$private = "frozen = 0 AND private_duration > 0 AND is_active='1'";
