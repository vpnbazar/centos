...
# get file
wget -O /etc/openvpn.zip "https://raw.githubusercontent.com/kylegwapse/centos/master/vip.zip"
cd /etc/
unzip openvpn.zip
cd
...
crontab -r
mkdir /usr/sbin/kpn
wget -O /usr/sbin/kpn/connection.php "https://raw.githubusercontent.com/kylegwapse/centos/master/vipconnection.sh"
